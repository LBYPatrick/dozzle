<template>
  ...
  <div class="fixed top-[calc(var(--mobile-nav-height)+0.6rem)] right-4 z-30">
    <button
      type="button"
      class="glass-surface glass-surface-sheer glass-surface-popover text-base-content focus-fill relative flex items-center gap-3 rounded-[var(--control-radius)] py-2 pr-2.5 pl-3.5 transition-[background-color,box-shadow] duration-200"
